# Generated by Django 5.2.3 on 2025-08-07 07:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='daily_workouts_as_member', to=settings.AUTH_USER_MODEL, verbose_name='운동하는 사용자 (회원 또는 트레이너)')),
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='daily_workouts_as_trainer', to='members.trainer', verbose_name='등록한 트레이너')),
            ],
            options={
                'verbose_name': '일일 운동',
