# Generated by Django 5.2.3 on 2025-08-05 07:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.CharField(blank=True, choices=[('맨몸', '맨몸'), ('덤벨', '덤벨'), ('바벨', '바벨'), ('머신', '머신'), ('케이블', '케이블'), ('스미스 머신', '스미스 머신'), ('밴드', '밴드'), ('스트레칭', '스트레칭'), ('유산소', '유산소')], max_length=50, null=True, verbose_name='운동 도구')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='생성일시')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exercise', to='workouts.exercisecategory', verbose_name='운동 카테고리')),
            ],
            options={
                'verbose_name': '운동',
        ...
        migrations.AddIndex(
            model_name='exercise',
            index=models.Index(fields=['category', 'is_active'], name='workouts_ex_categor_399796_idx'),
        ),
        migrations.AddIndex(
            model_name='exercise',
            index=models.Index(fields=['equipment'], name='workouts_ex_equipme_727db8_idx'),
        ),
        migrations.AddIndex(
